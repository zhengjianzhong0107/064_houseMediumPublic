...
import com.huc.system.service.ISysPostService;
...
public class SysUserController extends BaseController {
     ...
     * 获取经纪人列表
     */
    @GetMapping("/list/jingji")
    public TableDataInfo listJingji(SysUser user) {
        startPage();
        List<SysUser> list = userService.listJingji(user);
        return getDataTable(list);
    }
