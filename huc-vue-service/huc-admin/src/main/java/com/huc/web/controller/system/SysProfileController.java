...
import com.huc.common.utils.file.MimeTypeUtils;
...
public class SysProfileController extends BaseController {
    ...
    public AjaxResult updateProfile(@RequestBody SysUser user) {
        ...
        if (userService.updateUserProfile(user) > 0) {
            ...
            sysUser.setDemand(user.getDemand());
            sysUser.setCityCode(user.getCityCode());
            sysUser.setCityName(user.getCityName());
    ...
    public AjaxResult avatar(@RequestParam("avatarfile") MultipartFile file) throws Exception {
        if (!file.isEmpty()) {
            LoginUser loginUser = getLoginUser();
            String avatar = FileUploadUtils.upload(HucConfig.getAvatarPath(), file, MimeTypeUtils.IMAGE_EXTENSION);
